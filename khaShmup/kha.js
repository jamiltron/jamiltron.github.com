...
Gun.prototype = {
	...
	,shoot: function(x,y) {
		if(this.cooldownLeft <= 0) {
			...
			var adjX = x - Std["int"](this.bulletImage.get_width() / 2);
			var _g1 = 0;
...
Ship.prototype = {
	...
	,update: function(controls,deltaTime) {
		...
		if(controls.left && !controls.right) {
			...
			var _g1 = this;
			_g1.set_x(_g1.x + Math.round(this.speed * deltaTime));
		}
		if(controls.up && !controls.down) {
			var _g2 = this;
			_g2.set_y(_g2.y - Math.round(this.speed * deltaTime));
		} else if(controls.down && !controls.up) {
			var _g3 = this;
			_g3.set_y(_g3.y + Math.round(this.speed * deltaTime));
		}
		if(this.gun != null) {
